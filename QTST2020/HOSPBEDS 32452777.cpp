...
void solve(){
    ...
    for(ll d1=0;d1<tt;d1++){
		...
		for(i=0;i<n;i++){
			for(j=0;j<n;j++){
				if(j==0){
					if((arr[i][j]==1 && arr[i][j+1]==1)	||(arr[i][j]==1 && arr[i+1][j]==1)){
						flag=1;
						break;
					}
				}
					...
					if((arr[i][j]==1 && arr[i+1][j]==1)	||(arr[i][j]==1 && arr[i][j+1]==1)){
						flag=1;
						break;
					}
				}
				    ...
				    if((arr[i][j]==1 && arr[i-1][j]==1)	||(arr[i][j]==1 && arr[i][j-1]==1) ||(arr[i][j]==1 && arr[i+1][j]==1) || (arr[i][j]==1 && arr[i][j+1]==1)){
						flag=1;
						break;
					}	
				}
