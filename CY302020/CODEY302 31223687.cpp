...
ll ways(const string& str, ll x){
	   if(x==str.size()){
		   return 1;
	   }
	   else if(str[x]=='0')return 0;
	   else if(str[x]>'2')return ways(str,x+1);
	   else if(x+1>=str.size())return ways(str,x+1);
	   else if(str[x]=='1' || str[x]=='2' && str[x+1]<'7')return (ways(str,x+1)+ways(str,x+2));
	   else return ways(str,x+1);
}
