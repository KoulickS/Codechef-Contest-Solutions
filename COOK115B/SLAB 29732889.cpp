...
//Taken from https://www.geeksforgeeks.org/reverse-a-string-in-c-cpp-different-methods/
bool ispalin(string str) 
{ 
    ll l = 0;  ll h = str.length() - 1; 
...
void solve(){
    ...
    double sum=0;
		...
		if(N>1500000){
            sum+=(0.3*(N-1500000)); sum+=(.25*(1500000-1250000));sum+=(.20*(1250000-1000000));sum+=(.15*(1000000-750000));sum+=(.10*(750000-500000));sum+=(.05*(500000-250000));
        }
        else if(N>1250000){
            sum+=(.25*(N-1250000));sum+=(.20*(1250000-1000000));sum+=(.15*(1000000-750000));sum+=(.10*(750000-500000));sum+=(.05*(500000-250000));
        }
        else if(N>1000000){sum+=(.20*(N-1000000));sum+=(.15*(1000000-750000));sum+=(.10*(750000-500000));           sum+=(.05*(500000-250000));
        }
        else if(N>750000){sum+=(.15*(N-750000));sum+=(.10*(750000-500000));sum+=(.05*(500000-250000));
        }
        else if(N>500000){sum+=(.10*(N-500000));sum+=(.05*(500000-250000));
        }
        else if(N>250000){sum+=(.05*(N-250000));
        } cout<<N-(ll)sum<<endl;
	}
  }
int main()
